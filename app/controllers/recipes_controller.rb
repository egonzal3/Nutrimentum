class RecipesController < ApplicationController
  def index
    ...
    @recipes = @q.result(:distinct => true).includes(:ingred1, :ingred2, :ingred3, :ingred4, :ingred5, :meals).page(params[:page]).per(10)
  ...
  def create_row_from_base_ingredient
    @recipe = Recipe.new
    ...
    if @recipe.valid?
      ...
      redirect_to("/base_ingredients/#{@recipe.ingredient1}", notice: "Recipe created successfully.")
    else
      render("recipe_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def create_row_from_base_ingredient
    ...
    if @recipe.valid?
      ...
      redirect_to("/base_ingredients/#{@recipe.ingredient2}", notice: "Recipe created successfully.")
    else
      render("recipe_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def create_row_from_base_ingredient
    ...
    if @recipe.valid?
      ...
      redirect_to("/base_ingredients/#{@recipe.ingredient3}", notice: "Recipe created successfully.")
    else
      render("recipe_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def create_row_from_base_ingredient
    ...
    if @recipe.valid?
      ...
      redirect_to("/base_ingredients/#{@recipe.ingredient4}", notice: "Recipe created successfully.")
    else
      render("recipe_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def create_row_from_base_ingredient
    ...
    if @recipe.valid?
      ...
      redirect_to("/base_ingredients/#{@recipe.ingredient5}", notice: "Recipe created successfully.")
    else
      render("recipe_templates/new_form_with_errors.html.erb")
    end
  end
  ...
  def destroy_row_from_ingred1
    ...
    redirect_to("/base_ingredients/#{@recipe.ingredient1}", notice: "Recipe deleted successfully.")
  end
  ...
  def destroy_row_from_ingred2
    ...
    redirect_to("/base_ingredients/#{@recipe.ingredient2}", notice: "Recipe deleted successfully.")
  end
  ...
  def destroy_row_from_ingred3
    ...
    redirect_to("/base_ingredients/#{@recipe.ingredient3}", notice: "Recipe deleted successfully.")
  end
  ...
  def destroy_row_from_ingred4
    ...
    redirect_to("/base_ingredients/#{@recipe.ingredient4}", notice: "Recipe deleted successfully.")
  end
  ...
  def destroy_row_from_ingred5
    ...
    redirect_to("/base_ingredients/#{@recipe.ingredient5}", notice: "Recipe deleted successfully.")
  end
